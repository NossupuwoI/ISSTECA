                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="form-group" action="/filiere/traitement" method="POST">
                                @csrf
                            ...
                            <tr>
                                ...
                                <td>
                                  ...
                                  <button class ="btn btn-primary editbtn" type="submit">
                                    ...
                                    <a onclick="return confirm('Voulez vous vraimment supprimer la Filiere ?')" href="/deletefiliere/{{ $filiere->id }}" class ="btn btn-danger deletebtn">
