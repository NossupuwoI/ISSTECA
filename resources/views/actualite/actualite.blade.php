            ...
            <div class="row">
              <div class="mb-3">
                <label for="exampleInputPassword1"
                    class="form-label">Nom de l'actualité</label>
              ...
              <div class="mb-3">
                <label for="exampleInputPassword1"
                    class="form-label">Description de l'actualité</label>
                <input type="text" class="form-control input-default"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="form-group" action="/actualite/traitement" method="POST">
                                @csrf
                            ...
                            <tr>
                                ...
                                <td>
                                  ...
                                  <button class ="btn btn-primary editbtn" type="submit">
                                    ...
                                    <a onclick="return confirm('Voulez vous vraimment supprimer l\'actualité ?')" href="/deleteactualite/{{ $actualite->id }}" class ="btn btn-danger deletebtn">
